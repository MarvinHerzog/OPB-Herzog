...
// \include\lib\_global\_v2\utils\_base\detect_font_size.js 
...
// \include\lib\_global\_v2\document\_base\mouse.js 
...
// \include\lib\_global\_ui\_ex\overlay\url_draggable_toolbar.js 
...
// \include\lib\_global\features\syi3\category\_base\selector.js 
...
// \include\lib\_global\features\syi3\category\shared.js 
...
{var p=this.parent;p.startOver(p.oCatConfig);this.show(false);}}
...
// \include\lib\_global\features\syi3\category\_base\express_cat.js 
...
// \include\lib\_global\_ui\_ex\category_selector_filmstrip.js 
...
this.writeUI(rt,pC);var oM=this.parent.addMember(this.name,this.sChildName,rt.oConfig.sLayerPrefix);oM.bind();this.fillValues(false);oStartOvr=ebay.oP.controls["lnkStartOver"];if(oStartOvr.eElem)
oStartOvr.show(true);}
...
// \include\lib\_global\features\syi3\category\browse.js 
...
{var v=this.getValue();this.parent.oContinueButton.enable(v&&v.length>0,true);var i=((this.parent.isSecondary)?1:0);if(aCatInputs[i])
aCatInputs[i].setValue(this.getValue());}
oT.subscribeEvents("onkeypress","onpaste");oT.onpaste=function(){this.parent.oContinueButton.enable(true,true);}
oT.onkeypress=function()
...
var oTitleLyr=oD._getControl(c.sTitleLayerName);if((txt!="")&&(txt.has("<li>")))
{this.show(true);oTitleLyr.show(true);p.oContinueButton.enable(true,true);p.oContinueButton.eElem.setAttribute("aria-disabled",false);}
else
{this.show(false);oTitleLyr.show(false);p.oContinueButton.enable(false,true);p.oContinueButton.eElem.setAttribute("aria-disabled",true);}
var catboxlyr=new EbayHTMLLayer(this,c.sCatBoxesLayerName);catboxlyr.bind();catboxlyr.focus(true);}
...
this.resetBrowsePanel(tmp);if(pId)
this.resetBrowsePanel(pId);oStartOvr=ebay.oP.controls["lnkStartOver"];if(oStartOvr.eElem)
oStartOvr.show(false);break;}}
...
// \include\lib\_global\features\syi3\catalog\autocomplete.js 
...
// \include\lib\_global\features\tracking\tracking.js 
...
// \include\lib\_global\features\syi3\category\category_browse_soj_tag_fields.js 

var aSOJTagFields=['startSellingVin_helpLink','helpBtnlink','cntctusLnk','aidZ4','searchcatlink','browsecatlink','recentcatlink','aidZ1','remove_cat','suggestedMore','lnkStartOver','pcat'];
// b=18348438 -->